...
keybindings.set_globals = function ()
    local globalkeys = keybindings.globalkeys
...
keybindings.client_keys = gears.table.join(
    awful.key({ modkey,           }, "f",
      function (c)
...
keybindings.client_buttons = gears.table.join(
