...
binding.add_global_range({
  ...
  binding.new({
    ...
    on_press = function()
      helper_client.mouse_resize(true)
    end,
  }),
  ...
  binding.new({
    ...
    on_press = function()
      awful.spawn.with_shell(config.actions.show_launcher)
    end,
  }),
  ...
  binding.new({
    ...
    on_press = function()
      awful.spawn.with_shell(config.commands.magnifier)
    end,
  }),
  ...
  binding.new({
    ...
    on_press = function(trigger)
      awful.spawn("playerctl " .. trigger.action)
    end,
  }),
  ...
  binding.new({
    ...
    on_press = function(trigger)
      awful.spawn("playerctl position 5" .. trigger.direction)
    end,
  }),
  ...
  binding.new({
    ...
    on_press = function(trigger)
      awful.spawn("playerctl position 30" .. trigger.direction)
    end,
  }),
...
if config.features.screenshot_tools then
  binding.add_global_range({
    ...
    binding.new({
      ...
      on_press = function()
        services.screenshot.take({ mode = "selection", output = "clipboard" })
      end,
    }),
